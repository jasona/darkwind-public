...
| --- | --- | --- |
| [Dailos](dailos.md) | Magenta | Disease, chaos, plague, savagery, and the God of Disease |
| [Markas](markas.md) | Red | Strength, stability, beauty, healing, and sanctuary |
| [Tekal](tekal.md) | Green | Knowledge, balance, Luna, cybernetics, and advanced technology |
...
Moon phases affect travel time, but no phase closes a route. A visible destination moon opens its gate immediately. If the destination is new, the Afterlight Relay borrows light from the brightest visible moon and opens after three seconds. During the rare alignment when all three moons are new, the Eclipse Reserve releases stored afterlight and opens any route after eight seconds. These slower passages cost nothing; the traveler only needs to remain still, alive, connected, and out of combat while the route forms.

The gate and each portal chamber describe their current travel mode when examined. Return travel from a moon to Darkwind remains immediate.

Each moon moves through eight phases on a real-time clock. Markas changes phase every 2.5 hours, Dailos every 3.75 hours, and Tekal every 10 hours. Their complete cycles take 20, 30, and 80 hours respectively, and continue independently of game reboots.
