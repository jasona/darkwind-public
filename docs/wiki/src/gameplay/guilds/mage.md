...
working and use it rather differently. Damage-bearing runes normally add a
separate ten-percent supplement apiece instead of replacing or diluting the
working's native damage. Trivlian is the deliberate exception: his rune
converts the native damage to evil and acid.
